  ...
  return (
    <footer className="mt-auto w-full bg-asphalt text-white">
      <div className="mx-auto grid max-w-7xl grid-cols-3 gap-10 px-4 py-14 max-md:grid-cols-1">
        ...
        <div>
          <h2 className="mb-3 font-heading text-lg tracking-wide">Contact</h2>
          ...
          <p className="mt-2 text-sm text-white/80">Fax {company.phones.fax.display}</p>
          <p className="text-sm">
        ...
        <div>
          <h2 className="mb-3 font-heading text-lg tracking-wide">Licenses</h2>
          ...
          <h3 className="mt-6 mb-2 text-sm font-semibold uppercase tracking-wider text-white/60">Service areas</h3>
          <ul className="columns-2 gap-4 text-sm text-white/80">
            {cities.map((c) => (
              <li key={c.slug} className="break-inside-avoid">
                <Link className="hover:text-white" href={`/${c.slug}`}>
                  {c.name}
                </Link>
              </li>
            ))}
