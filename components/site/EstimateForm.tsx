    ...
    <form action={action} suppressHydrationWarning className={cn("grid gap-2 md:gap-3", className)}>
      ...
      <div className="grid grid-cols-2 gap-2 md:gap-3">
        <div className="grid gap-1 md:gap-1.5">
          <label htmlFor={`${type}-name`} suppressHydrationWarning className="text-xs font-medium md:text-sm">{t.form.name}</label>
        ...
        <div className="grid gap-1 md:gap-1.5">
          <label htmlFor={`${type}-phone`} suppressHydrationWarning className="text-xs font-medium md:text-sm">{t.form.phone}</label>
      ...
      <div className="grid gap-1 md:gap-1.5">
          <label htmlFor={`${type}-email`} suppressHydrationWarning className="text-xs font-medium md:text-sm">{t.form.email}</label>
      ...
      {type === "estimate" ? (
        <div className="grid grid-cols-2 gap-2 md:gap-3">
          <div className="grid gap-1 md:gap-1.5">
            <label htmlFor="service" suppressHydrationWarning className="text-xs font-medium md:text-sm">{t.form.service}</label>
            <select
              id="service"
              name="service"
          ...
          <div className="grid gap-1 md:gap-1.5">
            <label htmlFor="city" suppressHydrationWarning className="text-xs font-medium md:text-sm">{t.form.city}</label>
      ...
      <div className="grid gap-1 md:gap-1.5">
        <label htmlFor={`${type}-message`} suppressHydrationWarning className="text-xs font-medium md:text-sm">
      ...
      <Button type="submit" disabled={pending} suppressHydrationWarning className="h-10 bg-red-flag text-sm font-bold text-white hover:bg-red-flag/90 md:h-12 md:text-base">
        {pending
          ? t.form.sending
          : type === "feedback"
            ? t.form.sendFeedback
